...
def test_recommender():
    ...
    VALID_TYPES = {"tcp_basic","tcp_syn","udp_scan","service_detect","version_deep",
                   "os_detect","port_range","enum_scripts",None}
...
def test_validators():
    ...
    check("enum_scripts in allowed",     "enum_scripts" in ALLOWED_SCAN_TYPES)
    check("8 total scan types",          len(ALLOWED_SCAN_TYPES) == 8)
...
def test_report_builder():
    ...
    analysis = {
        ...
        "recommendation":{"title":"Version Deep","reason":"Outdated.","scan_type":"version_deep","alternatives":[]}
    }
